...
public class Character {
    ...
    public static void define(){
        Charmon pikachu = new Charmon("Pikachu", Type.ELECTRIC, 35, 55, 40, "assets\\pikachu");
        ...
        Charmon bulbasaur = new Charmon("Bulbasaur", Type.GRASS, 45, 49, 49, "assets\\bulbasaur");
        ...
        Charmon squirtle = new Charmon("Squirtle", Type.WATER, 44, 48, 65, "assets\\squirtle");
        ...
        Charmon charmander = new Charmon("Charmander", Type.FIRE, 39, 52, 43, "assets\\charmander");
        ...
        Charmon hoothoot = new Charmon("Hoothoot", Type.NORMAL, 60, 30, 30, "assets\\hoothoot");
        ...
        Charmon pidgey = new Charmon("Pidgey", Type.NORMAL, 40, 45, 40, "assets\\pidgey");
        ...
        Charmon jigglypuff = new Charmon("Jigglypuff", Type.NORMAL, 115, 45, 20, "assets\\jigglypuff");
        ...
        Charmon meowth = new Charmon("Meowth", Type.NORMAL, 40, 45, 35, "assets\\meowth");
        ...
        Charmon growlithe = new Charmon("Growlithe", Type.FIRE, 55, 70, 45, "assets\\growlithe");
        ...
        Charmon eevee = new Charmon("Eevee", Type.NORMAL, 55, 55, 50, "assets\\eevee");
        ...
        Charmon flareon = new Charmon("Flareon", Type.FIRE, 65, 130, 60, "assets\\flareon");
        ...
        Charmon nidoran = new Charmon("Nidoran", Type.NORMAL, 55, 47, 52, "assets\\nidoran");
        ...
        Charmon clefairy = new Charmon("Clefairy", Type.NORMAL, 70, 45, 48, "assets\\clefairy");
        ...
        Charmon abra = new Charmon("Abra", Type.NORMAL, 25, 20, 15, "assets\\abra");
        ...
        Charmon sandshrew = new Charmon("Sandshrew", Type.NORMAL, 50, 75, 85, "assets\\sandshrew");
