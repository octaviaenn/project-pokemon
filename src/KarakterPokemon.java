...
public class KarakterPokemon extends JFrame {
    ...
    public KarakterPokemon() {
        ...
        JPanel mainPanel = new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                try {
                    Image backgroundImage = new ImageIcon(getClass().getResource("/assets/bg-character.png"))
                            .getImage();
        ...
        try {
            ImageIcon backIcon = new ImageIcon(getClass().getResource("/assets/home.png"));
            if (backIcon.getImage() != null) {
                Image scaledBackImage = backIcon.getImage().getScaledInstance(140, 50, Image.SCALE_SMOOTH);
        ...
        try {
            ImageIcon startIcon = new ImageIcon(getClass().getResource("/assets/start.png"));
            if (startIcon.getImage() != null) {
                Image scaledStartImage = startIcon.getImage().getScaledInstance(200, 180, Image.SCALE_SMOOTH);
    ...
    private JPanel createCharacterCard(String pokemonName) {
        ...
        String gifPath = switch (pokemonName) {
            ...
            case "Nidoran" -> "/assets/charmon/nidoran-f.gif";
        ...
        try {
            ...
            if (imgURL != null) {
                imageLabel = new JLabel(new ImageIcon(imgURL));
            } else {
                imageLabel = new JLabel(pokemonName + " Image", SwingConstants.CENTER);
                imageLabel.setBackground(new Color(174, 177, 127));
                imageLabel.setOpaque(true);
                System.err.println("Gambar tidak ditemukan: " + gifPath);
            }
        } catch (Exception e) {
            imageLabel = new JLabel(pokemonName + " Image", SwingConstants.CENTER);
    ...
    private void showCharacterPopup(String pokemonName) {
        JDialog popup = new JDialog(this, pokemonName + " Details", true);
